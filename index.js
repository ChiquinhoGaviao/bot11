  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("bosta")){
		...
		if (messagesC.includes("corno")){
			client.updatePresence(from, Presence.composing)
			reply("茅 mesmo 茅? E Teu Pai Tbm E")
	}
		...
		if (messagesC.includes("bot")){
			...
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('/storage/emulated/0/Download/bot10-master/bot10-master/assets/Biel Janta - Aí meu C_zinho(MP3_160K).mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
				if (messagesC.includes("Gado,")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('/storage/emulated/0/Download/bot10-master/bot10-master/assets/');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
...
// recursos anime, random @nabuto domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*鈺攢鈹�鈹�鈹�*銆� *ADMINBOT Chiquinho鉁�* 銆峔n*鈹�+ wa.me/554184537851*鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� *Chiquinho* 銆�*鈹�鈹�鈹�鈹�*\n\n*_SE QUER SER ADMIN DO BOT Chiquinho_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'porno':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'vai bater uma logo Punheteiro fdp kkkkkkk'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'gasosa'})
